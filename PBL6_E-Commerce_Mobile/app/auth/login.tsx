  ...
  const handleGoogleLogin = async () => {
    if (!isGoogleConfigured()) {
      Alert.alert(
        ...
        'Để kích hoạt:\n\n' +
        '1️⃣ Tạo Google OAuth credentials tại:\n   console.cloud.google.com\n\n' +
        '2️⃣ Lấy Web Client ID và Android Client ID\n\n' +
        '3️⃣ Cập nhật GOOGLE_CONFIG trong:\n   services/socialAuthService.ts\n\n' +
    ...
    try {
      ...
      Alert.alert(
        'Google Login Error',
        error.message || 'Không thể mở Google login. Vui lòng thử lại.'
      );
    }
  };
