...
export const GOOGLE_CONFIG = {
  ...
  // Use same as webClientId for Expo Go
  expoClientId: '675831796221-gv53a00leksrq5f08lbds5kej9jjlm4q.apps.googleusercontent.com',
};
...
export const useGoogleSignIn = () => {
  // Let Expo generate the redirect URI automatically
